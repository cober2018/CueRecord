...
final class InterfaceLanguageSettings: ObservableObject {
    ...
    private static let zhHans: [String: String] = [
        ...
        "Screen permission needed": "需要屏幕录制权限",
        "Microphone permission needed": "需要麦克风权限",
        "Camera permission needed": "需要摄像头权限",
        "Waiting for video": "等待画面",
        "Microphone permission is required.": "需要麦克风权限。",
        "No microphone input device is available.": "没有可用的麦克风输入设备。",
        "Camera permission is required.": "需要摄像头权限。",
        "No camera device is available.": "没有可用的摄像头设备。",
        "Camera is still starting. Wait for the preview, then try again.": "摄像头还在启动，请等预览画面出现后再开始。",
        "Checking speech…": "正在核对语音…",
        "Finding your place… tap a word": "正在重新定位…可点按文字继续",
        "Mode": "模式",
        "Full": "全屏",
        "Area": "区域",
        "Window": "窗口",
